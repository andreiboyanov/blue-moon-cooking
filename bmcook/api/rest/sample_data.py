RECIPES = [
    ...
    },
    {
        ...
        "preparation": """
            ...
            Put the baking tray into the preheated oven or under the grill to melt the cheese until bubbling and golden. Keep an eye on it and make sure it doesn’t burn! When the cheese is bubbling, very carefully lift out the tray and carry it to the table. Enjoy.
        """,
        ...
        "ingredients": [
            ...
            ("red onion", 5, "pcs"),
            ("white onions", 3, "pcs"),
            ("banana shallots", 3, "pcs"),
            ("leeks", 300, "g"),
            ("butter", 100, "g"),
            ("olive oil", None, None),
            ("fresh sage leaves", 1, "good handful"),
            ("organic beef, vegetable or chicken stock", 2, "liters"),
            ("good-quality stale bread", 8, "cm"),
            ("Cheddar cheese", 200, "g"),
            ("Worcestershire sauce", None, None),
        ]
    },
]
